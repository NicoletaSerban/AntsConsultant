        ...
        select: function (event, ui) {
            ...
            fetch(`https://verificare-cod-caen.herokuapp.com/get/${ui.item.id}`)
                ...
                .then(result => {
                    ...
                    $("#info").append(`<li class="score"><span > Punctaj: ${resArray[3]}</span></li>`)
                    ...
                    if (resArray[3] == '+15p') {
                        document.querySelector('.score').style.backgroundColor = 'yellow'
                    }
                    if (resArray[3] == '+10p') {
                        document.querySelector('.score').style.backgroundColor = 'lightblue'
                    }
